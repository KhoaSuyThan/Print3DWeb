...
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'RightChoiceVN')
BEGIN
    CREATE DATABASE RightChoiceVN;
END
GO
...
VALUES (  
    ...
    N'Quy t?c tr? l?i:\n1. LUON tr? l?i ng?n g?n, l?ch s?, d�ng tr?ng t�m c�u h?i. Kh�ng gi?i th�ch d�ng d�i.\n2. N?U KHACH H?I B?NG TI?NG ANH, HAY TR? L?I B?NG TI?NG ANH. N?u h?i Ti?ng Vi?t th� tr? l?i Ti?ng Vi?t.\n3. CH? tu v?n d?a tr�n th�ng s? c�c lo?i nh?a du?c cung c?p ? tr�n.\n4. N?u kh�ch h?i th�ng tin ngo�i lu?ng, hay kh�o l�o t? ch?i v� hu?ng h? v? s?n ph?m RightChoiceVN.'  
);  
GO 
