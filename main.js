...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        vi: {
            ...
            "about.statSize": "Chuẩn Kích Thước",
            "about.statFormula": "Công Thức Resin",
            "about.storyTitle": "Sứ Mệnh Khát Vọng",
            "about.storyLead": "Mang cơ hội tiếp cận dòng nhựa in 3D chất lượng đẳng cấp thế giới đến từng nhà sáng chế, xưởng dịch vụ và khách hàng công nghiệp tại Việt Nam.",
            "about.storyDesc": "Chúng tôi tin rằng tốc độ, chất lượng và niềm tin nội địa phải song hành. RightChoiceVN không chỉ là nhà sản xuất hạt nhựa quang học quang trùng hợp (photopolymer) hiệu năng cao đầu tiên tại Việt Nam, mà còn là đối tác đồng hành tin cậy kiến tạo nên sự phát triển bền vững của hệ sinh thái in 3D nước nhà.",
            "about.checkTitle1": "Phòng Lab R&D Độc Quyền",
            "about.checkDesc1": "Liên tục nghiên cứu chuyên sâu, cải tiến polyme dựa trên phản hồi thực tế từ các lab in lớn.",
            "about.checkTitle2": "Giao Hàng Siêu Tốc SLA",
            "about.checkDesc2": "Mạng lưới giao vận tối ưu giúp vận chuyển vật liệu in nhanh trong vòng 2-5 ngày toàn quốc.",
            "about.checkTitle3": "Cam Kết Chất Lượng Đầy Đủ",
            "about.checkDesc3": "Mỗi lô hàng xuất xưởng đều dán mã QC Batch Code minh bạch, cho phép truy xuất nguồn gốc.",
            "about.pillarTitle1": "Sản Xuất Nội Địa",
            "about.pillarDesc1": "Nghiên cứu và sản xuất 100% tại Việt Nam với tiêu chuẩn chất lượng QC nghiêm ngặt cho từng chai nhựa xuất xưởng.",
            "about.pillarTitle2": "Tầm Nhìn Toàn Cầu",
            "about.pillarDesc2": "Hiện đang phân phối rộng khắp khu vực Châu Á - Thái Bình Dương (APAC) và chuẩn bị mở rộng sang thị trường quốc tế.",
            "about.pillarTitle3": "Đổi Mới & R&D",
            "about.pillarDesc3": "Phát triển liên tục các công thức hạt nhựa và polymer mới, dẫn đầu công nghệ vật liệu in 3D quang học hóa.",
            ...
            "products.badgeStandard": "Dòng Phổ Thông",
            "products.badgeArt": "Dòng Mỹ Thuật",
            "products.badgeSpecialty": "Dòng Chuyên Dụng",
            "products.badgeDental": "Dòng Nha Khoa",
            ...
            "products.flexibilityLabel": "Độ Dẻo",
            "products.flexibilityValMedium": "Trung bình",
            "products.flexibilityValLow": "Thấp",
            "products.flexibilityValHigh": "Cực cao",
            "products.safetyLabel": "An toàn",
            "products.safetyValHigh": "Cực Cao",
            "products.durabilityLabel": "Độ Bền",
            "products.durabilityValExcel": "Tuyệt vời",
            "products.tempLabel": "Nhiệt độ",
        ...
        en: {
            ...
            "about.statSize": "Dimensional Accuracy",
            "about.statFormula": "Resin Formulas",
            "about.storyTitle": "Our Aspirational Mission",
            "about.storyLead": "Providing world-class 3D printing resin quality to every maker, service bureau, and industrial client in Vietnam.",
            "about.storyDesc": "We believe speed, quality, and local trust must go hand in hand. RightChoiceVN is not only the first high-performance 3D printing photopolymer resin manufacturer in Vietnam but also a reliable partner in building the sustainable growth of the local 3D printing ecosystem.",
            "about.checkTitle1": "Exclusive R&D Lab",
            "about.checkDesc1": "Continuous in-depth research and polymer improvement based on actual feedback from major printing labs.",
            "about.checkTitle2": "SLA Express Delivery",
            "about.checkDesc2": "Optimized logistics network ensuring rapid material delivery within 2-5 days nationwide.",
            "about.checkTitle3": "Full Quality Commitment",
            "about.checkDesc3": "Every dispatched batch features a transparent QC Batch Code for complete traceability.",
            "about.pillarTitle1": "Local Manufacturing",
            "about.pillarDesc1": "100% researched and manufactured in Vietnam with strict QC standards for every shipped bottle.",
            "about.pillarTitle2": "Global Vision",
            "about.pillarDesc2": "Currently widely distributed across the Asia-Pacific (APAC) region and expanding to international markets.",
            "about.pillarTitle3": "Innovation & R&D",
            "about.pillarDesc3": "Continuous development of new resin and polymer formulas, leading the localized optical 3D printing materials technology.",
            ...
            "products.badgeStandard": "Standard Series",
            "products.badgeArt": "Art Series",
            "products.badgeSpecialty": "Specialty Series",
            "products.badgeDental": "Dental Series",
            ...
            "products.flexibilityLabel": "Flexibility",
            "products.flexibilityValMedium": "Medium",
            "products.flexibilityValLow": "Low",
            "products.flexibilityValHigh": "Extremely High",
            "products.safetyLabel": "Safety",
            "products.safetyValHigh": "Very High",
            "products.durabilityLabel": "Durability",
            "products.durabilityValExcel": "Excellent",
            "products.tempLabel": "Temperature",
